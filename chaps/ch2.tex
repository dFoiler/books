...
In order to define $\rho(w')$, we define a function $j\colon K^\times\to\CC$ by\footnote{This is the negative of how Piatetski-Shapiro defines $j$. However, Piatetski-Shapiro's definition makes \Cref{lem:j2} below off by a sign.}
\begin{equation}
